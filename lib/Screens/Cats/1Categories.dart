...
String token;
  ...
  fcmNotification() {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      ...
      if (notification != null && android != null) {
        ...
        if (message.notification.title == "تقيم الخدمة") {
          final order= message.notification.body.replaceAll(RegExp('[^0-9]'), '');
    ...
    FirebaseMessaging.onMessageOpenedApp.listen((RemoteMessage message) {
      ...
      if (message.notification.title == "تقيم الخدمة") {
        Navigator.push(context, MaterialPageRoute(builder: (context)=>Card6TaqeemElkhdma(
          vendorID: vendorID,
          token: token,
          orderId: order,
        ...
        Navigator.push(context, MaterialPageRoute(builder: (context)=>OrderStatus(orderID: order,)));
      }
      else
            ...
            child: InkWell(
              ...
              child:Column(
                ...
                children: [
                  ...
                  Text(translate('lan.branches2'),style: TextStyle(fontSize: 16,fontFamily:  'Tajawal'),)
                ],
              )
            ),
          ),
                              ...
                              return Builder(
                                builder: (BuildContext context) {
                                  return GestureDetector(
                                      onTap: () {
                                      int index=  allSliderHome.indexOf(banner);
                                       Navigator.push(context,
                                           MaterialPageRoute(
