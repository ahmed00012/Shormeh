...
bool loading = true;
  ...
  Future usePoints()async{
    ...
    var response = await http.get("${HomePage.URL}customer/convert-points", headers: {
      "Authorization": "Bearer $token",
    });
                        ...
                        Row(
                          children: [
                            ...
                            Padding(
                              ...
                              child:allPoints.length!=0? Text(
                                allPoints[0].total_points.toString(),
                                style: TextStyle(
                                    color: Color(0xff40976C),
                                    fontWeight: FontWeight.bold,
                                    fontSize: 20,
                          ...
                          children: [
                            ...
                            Padding(
                              padding:
                                  const EdgeInsets.only(left: 10, right: 10),
                              child: allPoints.length!=0?Text(
                               allPoints[0].points_to_cash.toString()+' ' +translate('lan.rs'),
                                style: TextStyle(
                                    color: Color(0xff40976C),
                                    fontWeight: FontWeight.bold,
                                    fontSize: 20,
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(  allPoints[index].converted==0?
                                translate('lan.notUsed'):
                                translate('lan.used'),  style: TextStyle(
                                    color: Color(0xff748b9d),
