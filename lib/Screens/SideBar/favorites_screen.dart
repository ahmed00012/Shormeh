...
class _FavoritesScreenState extends State<FavoritesScreen> {
  ...
  Future getMyProducts() async {
    allSubCats.clear();
    var response = await http.get("${HomePage.URL}customer/favourite/list", headers: {
  ...
  void removeProduct(int id) async {
    ...
    var respons = await http.post("${HomePage.URL}customer/favourite/toggle",
        headers: {
          "Authorization": "Bearer $token",
        },
        body: {
...
@override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: isIndicatorActive ? Center(
            child:Container(
              height: 100,
              width:100,
              child: Lottie.asset('assets/images/lf20_mvihowzk.json'),
            )
        ):allSubCats.isEmpty?Center(
          child: Column(
            ...
            children: [
              ...
              Container(
                height: 150,
                width:150,
                child: Lottie.asset('assets/images/lf20_mhrb2ucd.json'),
              ),
                        ...
                        child: Row(
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                lan=="ar"?
                                  allSubCats[index].nameAr:allSubCats[index].nameEn,
                                  style: TextStyle(
